...
docker rm -f cloudsuite-data-caching-drrio-test-client || true;
docker run --cpuset-cpus="1" -t --name cloudsuite-data-caching-drrio-test-client --net caching_network \
